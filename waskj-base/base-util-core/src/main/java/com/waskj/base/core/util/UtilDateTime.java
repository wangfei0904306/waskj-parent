...
public class UtilDateTime {
	...
	// public static String formatInterval(Date from, Date thru, int count,
	// Locale locale) {
	...
	// }
	//
	// public static String formatInterval(Timestamp from, Timestamp thru, int
	// count, Locale locale) {
	// return formatInterval(getInterval(from, thru), count, locale);
	// }
	//
	...
	// }
	//
	// public static String formatInterval(long interval, int count, Locale
	// locale) {
	...
	// }
	//
	// Map<String, Object> uiDateTimeMap =
	// UtilProperties.getResourceBundleMap("DateTimeLabels", locale);
	//
	...
	public static int getBetweenDays(Date counterTime, Date endTime, String format) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat(format);
//		endTime = sdf.parse(sdf.format(endTime));
//		counterTime = sdf.parse(sdf.format(counterTime));
		Calendar endCal = Calendar.getInstance();
		endCal.setTime(endTime);
		Calendar counterCal = Calendar.getInstance();
		counterCal.setTime(counterTime);
		return (int) ((endCal.getTimeInMillis() - counterCal.getTimeInMillis()) / (1000 * 3600 * 24));
	}
	...
	/**
	 * Returns a copy of <code>date</code> that cannot be modified. Attempts to
	 * modify the returned date will result in an
