...
public class AutoGenerator {
    ...
    public void generate() {
        ...
        try {
            ...
            for (String table : tables) {
                ...
                String baseBeanName = beanName.replace("Entity","");
                String mapperName = baseBeanName + "Mapper";
                String serviceName = baseBeanName + "Service";
                String serviceImplName = baseBeanName + "ServiceImpl";
    ...
    private String getBeanName(String table, boolean includePrefix) {
        ...
        return sb.toString().concat("Entity");
    }
...
//        int size = types.size();
    ...
    private void buildEntityBean(List<String> columns, List<String> types, List<String> comments, String tableComment,
        ...
        bw.write("import com.waskj.project.domain.core.BaseEntity;"); // 继承 BaseEntity
        bw.newLine();
        if (isDate(types)) {
    ...
    private void buildService(String beanName, String serviceName) throws IOException {
        ...
        if (config.getConfigIdType() == ConfigIdType.STRING) {
            ...
            bw.write("import com.waskj.project.api.core.BaseService;");
        }
        bw.newLine();
    ...
    private void buildServiceImpl(String beanName, String serviceImplName, String serviceName, String mapperName) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.waskj.project.provider.core.BaseServiceImpl;");
        bw.newLine();
        ...
        bw.write("public class " + serviceImplName + " extends " + " BaseServiceImpl "
                + "<" + mapperName + ", " + beanName + ",Long> implements " + serviceName + " {");
        bw.newLine();
        bw.newLine();
    ...
    private void buildSQL(BufferedWriter bw, Map<String, IdInfo> idMap, List<String> columns) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (idInfo != null) {
                ...
                bw.write(" " + column + " " + processField(column));
            }
            if (i != size - 1) {
                bw.write(",");
            }
